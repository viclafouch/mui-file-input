...
Then, you can use the different global class names (see below) to target an element of `MuiFileInput`.
...
| `.MuiFileInput-ClearIconButton`                        | 	Styles applied to the clear [IconButton](https://mui.com/material-ui/api/icon-button/) component.                                                                                                       |
